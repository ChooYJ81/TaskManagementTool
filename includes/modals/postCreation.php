  ...
  <div class="modal-dialog modal-dialog-centered" style="width:33rem">
    <div class="modal-content">
      <div class="modal-body d-flex flex-column align-items-center my-3">
        ...
        <p class="fw-light text-muted mb-4" style="font-size:0.75rem" id="postTitleDesc">You can invite people to your workspace via the generated code</p>

        <!-- Create workspace form section -->
        <img src="./images/workspaceCode.png" class="mb-4" style="width: 15rem" id="postImage"/>

        <h5 style="color:#2A386E" id="postSecTitle">Workspace Code:</h5>
        <h3 class="fw-semibold mb-4" id="postWorkspaceCode" style="color:#3284BA"></h3>

        <p class="fw-light text-muted mb-4 text-center" style="font-size:0.75rem" id="postSecDesc">To manage or send invitations via email, navigate to <br> Workspace > Manage Workspace</p>
