  ...
  <div class="modal-dialog modal-dialog-centered" style="width:33rem">
    <div class="modal-content">
      <div class="modal-body d-flex flex-column align-items-center my-3">
        ...
        <form class="w-100 px-5" id="createWorkspaceForm">
          <div class="mb-4">
          ...
          <div class="mb-4">
            ...
            <select class="form-select" aria-label="Small select example" id="workspaceType" required>
          ...
          <div class="mb-4">
            ...
            <textarea class="form-control" id="workspaceDesc" maxlength="100" rows="5" required>Enter workspace description</textarea>
          </div>
        </form>
        ...
        <button type="button" class="btn btn-primary mt-4 px-5" style="background-color:var(--blue)">Create</button>
